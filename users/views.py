...
def sign_up(request, user, **kwargs):
    animals = ["匿名變色龍", "匿名地鼠", "匿名雪貂", "匿名烏鴉", "匿名鴨嘴獸", "匿名海狸", "匿名孤狼", "匿名青蛙", "匿名水豚", "匿名浣熊", "匿名猴子", "匿名鬣蜥", "匿名奇異鳥", "匿名澳洲野犬", "匿名臭鼬", "匿名獨角鯨", "匿名蝙蝠", "匿名短尾矮袋鼠", "匿名蠑螈", "匿名恐龍", "匿名企鵝", "匿名灰熊", "匿名水滴魚", "匿名毛絲鼠", "匿名海豚",
    ...
    nickname = random.choice(animals)
    if Profile.objects.filter(nickname=nickname).exists():
        nickname = nickname+str(user.id)
